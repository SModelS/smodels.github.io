...
------------------------------------------------------------------------ 
### 12 Feb 2021: [SModelS version 2.0.0.beta](https://github.com/SModelS/smodels/releases) pre-release is now available [(what's new)](http://smodels.readthedocs.io/en/stable/ReleaseUpdate.html)
