...
comprising 80 individual maps from 15 distinct signal regions, 12 different SMS topologies, from a total of 4 analyses.
...
Link to list of results [without superseded results](ListOfAnalyses123charan).
    ## Individual tables
### Run 2 - 13 TeV
 * [CMS upper limits](#CMSupperlimits13): 3  analyses, 8  results
