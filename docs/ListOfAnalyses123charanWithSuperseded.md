...
comprising 12 individual maps from 4 distinct signal regions, 11 different SMS topologies, from a total of 4 analyses.
...
Link to list of results [without superseded results](ListOfAnalyses123charan).
    ## Individual tables
### Run 2 - 13 TeV
 * [CMS upper limits](#CMSupperlimits13): 4  analyses, 12  results
### Run 1 - 8 TeV
