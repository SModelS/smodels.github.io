...
comprising 82 individual maps from 15 distinct signal regions, 13 different SMS topologies, from a total of 4 analyses.
...
Link to list of results [without superseded results](ListOfAnalyses123charan).
    ## Individual tables
### Run 2 - 13 TeV
 * [CMS upper limits](#CMSupperlimits13): 3  analyses, 10  results
 * [CMS efficiency maps](#CMSefficiencymaps13): 1  analyses, 6  results
### Run 1 - 8 TeV
...
|--------|-----------------------|--------------|--------------|-------------------|-----------|
| **Publications** | | | | | |
| [CMS-SUS-16-033](http://cms-results.web.cern.ch/cms-results/public-results/publications/SUS-16-033/index.html)<a name="CMS-SUS-16-033"></a> | 0L + jets + MET (using MHT) | 35.9 | [T1](SmsDictionary123charan#T1), [T1bbbb](SmsDictionary123charan#T1bbbb), [T1tttt](SmsDictionary123charan#T1tttt), [T2bb](SmsDictionary123charan#T2bb), [T2tt](SmsDictionary123charan#T2tt), [TGQ](SmsDictionary123charan#TGQ) | |&#10004; |
