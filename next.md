...
------------------------------------------------------------------------ 
###  7 Aug 2024: [SModelS version 3.0.0](https://github.com/SModelS/smodels/releases) available ([what's new](https://smodels.readthedocs.io/en/latest/ReleaseUpdate.html))
