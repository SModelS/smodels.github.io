...
------------------------------------------------------------------------ 
### 28 Sep 2021: [SModelS version 2.1.0](https://github.com/SModelS/smodels/releases) is now available [(what's new)](http://smodels.readthedocs.io/en/latest/ReleaseUpdate.html)
------------------------------------------------------------------------   
